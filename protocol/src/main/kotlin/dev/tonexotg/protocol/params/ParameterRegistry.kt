...
object ParameterRegistry {
     ...
     * `SelfWideningParameterBounds` (same package), which are the only consumers of this set.
     *
     ...
     *   direct observation (issue #80, "Scope widened" follow-up comment). Both are unlabeled
